		...
		<div>
			...
			>
				<div className="flex sm:flex-col md:flex-row">
					...
					<Link
						href=""
						className=" md:w-40 md:ml-8 lg:w-40 lg:ml-8 rounded-md text-white  bg-teal-300 sm:py-2 sm:text-center  md:text-center md:px-4 md:py-4 lg:px-8 lg:py-4 sans-serif font-bold"
					>
						Shorten it!
					</Link>
				</div>
